...
import { fetchKeralaummary } from "@/lib/eci";
...
async function DashboardContent() {
  const summary = await fetchKeralaummary();
  ...
  const allianceBadges = [
    { label: "UDF", seats: allianceTotals["UDF"] ?? 0, color: "#3B82F6" },
    { label: "LDF", seats: allianceTotals["LDF"] ?? 0, color: "#EF4444" },
  ...
  return (
    <>
      ...
      <div className="text-center">
        ...
        >
          View all 140 constituency results
